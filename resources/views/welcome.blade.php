...
<head>
    ...
    <title>Echo | صدى - منصة الاقتباسات</title>
...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' }" x-init="$watch('darkMode', val => {
    ...
    <div class="min-h-screen flex flex-col">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 flex items-center">
                            ...
                            <span class="text-xl font-bold mr-2 text-gray-800 dark:text-gray-200">Echo | صدى</span>
                        </div>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div class="space-x-4 space-x-reverse">
                            @auth
                            <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-800 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 focus:outline focus:outline-2 focus:rounded-sm focus:outline-blue-500 transition-all duration-300">لوحة التحكم</a>
                            @else
                            <a href="{{ route('login') }}" class="font-semibold text-gray-800 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 focus:outline focus:outline-2 focus:rounded-sm focus:outline-blue-500 transition-all duration-300">تسجيل الدخول</a>

                            @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="font-semibold text-gray-800 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 focus:outline focus:outline-2 focus:rounded-sm focus:outline-blue-500 transition-all duration-300">إنشاء حساب</a>
                            @endif
                            @endauth
                        </div>
                        @endif
        ...
        <div class="hero-section">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center" data-aos="fade-up">
                    <h1 class="hero-title">Echo | صدى</h1>
        ...
        <div class="py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-10 text-center" data-aos="fade-up">اقتباسات مميزة</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- اقتباس 1 -->
                    <div class="quote-card-featured" data-aos="fade-up" data-aos-delay="100">
                        <p class="text-lg text-gray-800 dark:text-gray-200 mb-4">"لا تحكم على نجاحك بما تملكه من أشياء، بل بما تستطيع فعله دون أن تملك شيئاً."</p>
                        <div class="text-sm text-gray-800 dark:text-gray-400 font-medium mb-4">- جبران خليل جبران</div>
                    ...
                    <div class="quote-card-featured" data-aos="fade-up" data-aos-delay="200">
                        <p class="text-lg text-gray-800 dark:text-gray-200 mb-4">"الحياة إما أن تكون مغامرة جريئة أو لا شيء."</p>
                        <div class="text-sm text-gray-800 dark:text-gray-400 font-medium mb-4">- هيلين كيلر</div>
                        <div class="mt-4 flex space-x-2 space-x-reverse">
                            <span class="reaction-btn reaction-btn-like">
                                <svg class="h-4 w-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z"></path>
                    ...
                    <div class="quote-card-featured" data-aos="fade-up" data-aos-delay="300">
                        <p class="text-lg text-gray-800 dark:text-gray-200 mb-4">"لا تقلق بشأن الفشل، عليك أن تقلق بشأن الفرص التي تخسرها عندما لا تحاول حتى."</p>
                        <div class="text-sm text-gray-800 dark:text-gray-400 font-medium mb-4">- جاك كانفيلد</div>
                        <div class="mt-4 flex space-x-2 space-x-reverse">
                            <span class="reaction-btn reaction-btn-like">
                                <svg class="h-4 w-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z"></path>
        ...
        <div class="py-16 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-10 text-center" data-aos="fade-up">مميزات المنصة</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="feature-card" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">مكتبة اقتباسات متنوعة</h3>
                        <p class="text-gray-800 dark:text-gray-300">استكشف مجموعة واسعة من الاقتباسات الملهمة من مختلف المصادر والمؤلفين.</p>
                    </div>
                    <div class="feature-card" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">حفظ المفضلة</h3>
                        <p class="text-gray-800 dark:text-gray-300">احفظ اقتباساتك المفضلة في مكان واحد للرجوع إليها في أي وقت.</p>
                    </div>
                    <div class="feature-card" data-aos="flip-up" data-aos-delay="300">
                        ...
                        <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">التفاعل والمشاركة</h3>
                        <p class="text-gray-800 dark:text-gray-300">تفاعل مع اقتباسات الآخرين وشارك اقتباساتك الخاصة مع المجتمع.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-10 text-center" data-aos="fade-up">آراء المستخدمين</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md" data-aos="fade-up" data-aos-delay="100">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="mr-3">
                                <h4 class="font-bold text-gray-800 dark:text-gray-200">أحمد محمد</h4>
                        ...
                        <p class="text-gray-800 dark:text-gray-300">"منصة رائعة! أستخدمها يومياً لحفظ الاقتباسات التي تلهمني. التصميم سهل الاستخدام والميزات متنوعة."</p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="mr-3">
                                <h4 class="font-bold text-gray-800 dark:text-gray-200">سارة أحمد</h4>
                                <div class="flex text-yellow-400">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                        ...
                        <p class="text-gray-800 dark:text-gray-300">"أحب كيف يمكنني مشاركة اقتباساتي المفضلة مع الآخرين والتفاعل معهم. المنصة سهلة الاستخدام وتصميمها جميل."</p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md" data-aos="fade-up" data-aos-delay="300">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="mr-3">
                                <h4 class="font-bold text-gray-800 dark:text-gray-200">محمد علي</h4>
                                <div class="flex text-yellow-400">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                        ...
                        <p class="text-gray-800 dark:text-gray-300">"أفضل منصة للاقتباسات استخدمتها حتى الآن! أحب الوضع الليلي والتصميم البسيط. أنصح بها بشدة لكل محبي القراءة."</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cta-section">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-4" data-aos="fade-up">انضم إلينا اليوم</h2>
                <p class="text-xl text-gray-800 dark:text-gray-300 mb-8 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="100">سجل الآن واستمتع بتجربة فريدة في عالم الاقتباسات الملهمة.</p>
