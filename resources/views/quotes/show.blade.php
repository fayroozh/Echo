                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400">استخدم زر "مراسلة" في الملف الشخصي للمستخدم
                                    لبدء محادثة جديدة</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between">
                        <a href="{{ route('quotes.index') }}"
                            class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">العودة للاقتباسات</a>
                    </div>
                </div>
            </div>
        </div>
